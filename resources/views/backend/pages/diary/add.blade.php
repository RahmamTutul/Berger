...
@section('content')
    <div class="col-md-6 grid-margin stretch-card m-auto">
              <div class="card">
                ...
                @endif
                <div class="card-body">
                  <h4 class="card-title">INSERT DIARY INFO</h4>
                  <form class="forms-sample" action="{{ url('/diary/add') }}" method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <textarea name="details" class="form-control" id="exampleInputMobile" placeholder="Text.."></textarea>
                      </div>
                    </div>
                     <div class="form-group row">
